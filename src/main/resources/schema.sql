...
INSERT INTO t_metas (mid, name, slug, type, description, sort, parent) VALUES (6, '程征的技术博客', 'https://github.com/chengzheng', 'link', NULL, 0, 0);

-- 表：t_options
DROP TABLE IF EXISTS t_options;
CREATE TABLE t_options (name VARCHAR (100) PRIMARY KEY UNIQUE NOT NULL, value TEXT, description VARCHAR (255));
INSERT INTO t_options (name, value, description) VALUES ('site_title', '程征的技术博客', '');
...
INSERT INTO t_options (name, value, description) VALUES ('site_keywords', '博客系统', NULL);
INSERT INTO t_options (name, value, description) VALUES ('site_description', '博客系统', NULL);
